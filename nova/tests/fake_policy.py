...
policy_data = """
{
    ...
    "compute_extension:psvm:index": "",
    "compute_extension:psvm:show": "",
    "compute_extension:psvm:create": "rule:admin_api",
    "compute_extension:psvm:update": "rule:admin_api",
    "compute_extension:psvm:delete": "rule:admin_api",
    "compute_extension:psvmcred:index": "",
    "compute_extension:psvmcred:show": "",
    "compute_extension:psvmcred:create": "rule:admin_api",
    "compute_extension:psvmcred:update": "rule:admin_api",
    "compute_extension:psvmcred:delete": "rule:admin_api",
    "compute_extension:psvmpbind:index": "",
    "compute_extension:psvmpbind:show": "",
    "compute_extension:psvmpbind:create": "rule:admin_api",
    "compute_extension:psvmpbind:update": "rule:admin_api",
    "compute_extension:psvmpbind:delete": "rule:admin_api",
    ...
    "network:create_psvmcred": "",
    "network:update_psvmcred": "",
    "network:delete_psvmcred": "",
    "network:create_psvm": "",
    "network:update_psvm": "",
    "network:delete_psvm": "",
    "network:create_psvmpbind": "",
    "network:update_psvmpbind": "",
    "network:delete_psvmpbind": "",
